...
public class d2 extends c2 {
    ...
    static {
        ...
        H = sparseIntArray;
        sparseIntArray.put(nc.e.f41854z, 1);
        sparseIntArray.put(nc.e.V0, 2);
        sparseIntArray.put(nc.e.U0, 3);
    }
    ...
    public d2(androidx.databinding.e eVar, View view, Object[] objArr) {
        super(eVar, view, 0, (FrameLayout) objArr[1], (AppCompatImageView) objArr[3], (ClosetGestureView) objArr[2]);
        this.F = -1L;
