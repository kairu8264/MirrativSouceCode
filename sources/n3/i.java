...
public final class i {
    ...
    public static final Object f41564a = new Object();

    /* renamed from: b  reason: collision with root package name */
    public static char[] f41565b = new char[24];
    ...
    public static void d(long j10, PrintWriter printWriter, int i10) {
        synchronized (f41564a) {
            printWriter.print(new String(f41565b, 0, e(j10, i10)));
        }
    }
    ...
    public static int e(long j10, int i10) {
        ...
        int i15;
        long j11 = j10;
        if (f41565b.length < i10) {
            f41565b = new char[i10];
        }
        char[] cArr = f41565b;
