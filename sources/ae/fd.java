...
public class fd extends ed {
    ...
    static {
        ...
        sparseIntArray.put(nd.z0.f42277e5, 3);
    }
    ...
    public fd(androidx.databinding.e eVar, View view, Object[] objArr) {
        super(eVar, view, 0, (RoundedButtonView) objArr[3], (AppCompatTextView) objArr[2], (AppCompatImageView) objArr[1]);
        this.F = -1L;
