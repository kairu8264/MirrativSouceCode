...
public class zb extends yb {
    ...
    static {
        ...
        sparseIntArray.put(nd.z0.selected_oval_view, 2);
        sparseIntArray.put(nd.z0.selected_check_view, 3);
    }
    ...
    public zb(androidx.databinding.e eVar, View view, Object[] objArr) {
        super(eVar, view, 0, (AppCompatImageView) objArr[1], (View) objArr[3], (View) objArr[2]);
        this.F = -1L;
