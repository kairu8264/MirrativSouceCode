...
public class tl extends sl {
    ...
    static {
        ...
        sparseIntArray.put(nd.z0.A1, 8);
    }

    public tl(androidx.databinding.e eVar, View view) {
    ...
    public tl(androidx.databinding.e eVar, View view, Object[] objArr) {
        super(eVar, view, 0, (View) objArr[3], (View) objArr[2], (AppCompatImageView) objArr[8], (AppCompatTextView) objArr[5], (View) objArr[1], (AppCompatTextView) objArr[4], (TriangleView) objArr[7], (TriangleView) objArr[6]);
        this.K = -1L;
