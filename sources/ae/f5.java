...
public class f5 extends e5 {
    ...
    static {
        ...
        H = sparseIntArray;
        sparseIntArray.put(nd.z0.presets_recycler_view, 1);
        sparseIntArray.put(nd.z0.J, 2);
    ...
    public f5(androidx.databinding.e eVar, View view, Object[] objArr) {
        super(eVar, view, 0, (AppCompatImageView) objArr[2], (RecyclerView) objArr[1], (AppCompatTextView) objArr[3]);
        this.F = -1L;
