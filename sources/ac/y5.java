...
public class y5 extends x5 {
    ...
    public y5(androidx.databinding.e eVar, View view, Object[] objArr) {
        super(eVar, view, 0, (AppCompatImageView) objArr[3], (AppCompatTextView) objArr[4], (AppCompatImageView) objArr[2], (ConstraintLayout) objArr[1]);
        this.G = -1L;
