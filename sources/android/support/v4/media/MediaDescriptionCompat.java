    ...
    */
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        if (Build.VERSION.SDK_INT < 21) {
            ...
            TextUtils.writeToParcel(this.mTitle, parcel, i10);
            TextUtils.writeToParcel(this.mSubtitle, parcel, i10);
            TextUtils.writeToParcel(this.mDescription, parcel, i10);
            parcel.writeParcelable(this.mIcon, i10);
            parcel.writeParcelable(this.mIconUri, i10);
            parcel.writeBundle(this.mExtras);
            parcel.writeParcelable(this.mMediaUri, i10);
            return;
        }
