...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((b) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new b(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        e.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
                        a.c(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        public MediaSessionImplApi28(MediaSession mediaSession, c cVar, Bundle bundle) {
            super(mediaSession, cVar, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final b getCurrentControllerInfo() {
            return new b(this.mSessionFwk.getCurrentControllerInfo());
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(MediaSession mediaSession, c cVar, Bundle bundle) {
            super(mediaSession, cVar, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    i iVar = mediaSessionImplBase.mVolumeProvider;
                    if (i10 != 2) {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new b(MediaSessionImplBase.this.getPackageNameForUid(Binder.getCallingUid()), Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new b(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            c b10 = a.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, asInterface, b10);
        }
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                ...
                if (cVar != null) {
                    a.c(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, cVar);
                }
            }
            return bundle;
        }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, c cVar) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = r4.a.a(context)) == null) {
                ...
                if (i10 >= 21) {
                    ...
                    if (i10 >= 29) {
                        this.mImpl = new MediaSessionImplApi29(createFwkMediaSession, cVar, bundle);
                    } else if (i10 >= 28) {
                        this.mImpl = new MediaSessionImplApi28(createFwkMediaSession, cVar, bundle);
                    } else {
                        this.mImpl = new MediaSessionImplApi21(createFwkMediaSession, cVar, bundle);
                    }
                    ...
                    this.mImpl = new MediaSessionImplApi19(context, str, componentName2, pendingIntent2, cVar, bundle);
                } else if (i10 >= 18) {
                    this.mImpl = new MediaSessionImplApi18(context, str, componentName2, pendingIntent2, cVar, bundle);
                } else {
                    this.mImpl = new MediaSessionImplBase(context, str, componentName2, pendingIntent2, cVar, bundle);
                }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new b("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public MediaSessionImplApi21(MediaSession mediaSession, c cVar, Bundle bundle) {
            this.mSessionFwk = mediaSession;
            this.mToken = new Token(mediaSession.getSessionToken(), new ExtraSession(), cVar);
            this.mSessionInfo = bundle;
            setFlags(3);
        }
