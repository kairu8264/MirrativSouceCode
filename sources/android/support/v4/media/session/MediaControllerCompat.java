...
public final class MediaControllerCompat {
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        Object tag = activity.getWindow().getDecorView().getTag(f.f45786e);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(f.f45786e, mediaControllerCompat);
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + TopicConstant.SEPARATOR);
            }
        }
    }
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i10, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    ...
                    mediaControllerImplApi21.mSessionToken.setSession2Token(a.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
