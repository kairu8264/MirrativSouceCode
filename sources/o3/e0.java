...
public final class e0 {
    ...
    public static Method f43948a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f43948a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f43948a) != null) {
            try {
