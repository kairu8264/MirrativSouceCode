...
public class a extends c<Boolean> {
    ...
    public static final String f49743i = j.f("BatteryChrgTracker");
    ...
    */
    public void h(android.content.Context r6, android.content.Intent r7) {
        ...
        L7:
            k5.j r7 = k5.j.c()
            java.lang.String r0 = r5.a.f49743i
            r1 = 1
        ...
        L6c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: r5.a.h(android.content.Context, android.content.Intent):void");
    }
    ...
    public Boolean b() {
        ...
        if (registerReceiver == null) {
            j.c().b(f49743i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
