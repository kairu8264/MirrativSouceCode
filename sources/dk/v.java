...
public final class v {
    ...
    public static final f f29717a = new f("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                    f29717a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
