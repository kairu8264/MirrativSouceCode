...
public class i {
    ...
    public final Deque<WeakReference<XmlPullParser>> f29953a = new ArrayDeque();
    ...
    public boolean a(AttributeSet attributeSet) {
        if (attributeSet instanceof XmlPullParser) {
            ...
            if (xmlPullParser.getDepth() == 1) {
                XmlPullParser c10 = c(this.f29953a);
                this.f29953a.push(new WeakReference<>(xmlPullParser));
