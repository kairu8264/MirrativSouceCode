...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public View getView(int i10, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((a.c) getItem(i10), true);
            }
            ((TabView) view).bindTab((a.c) getItem(i10));
            return view;
        }
    }
    ...
    public class TabView extends LinearLayout {
        ...
        */
        public TabView(android.content.Context r6, e.a.c r7, boolean r8) {
            /*
                r4 = this;
            ...
            L31:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ScrollingTabContainerView.TabView.<init>(androidx.appcompat.widget.ScrollingTabContainerView, android.content.Context, e.a$c, boolean):void");
        }
        ...
        public void update() {
            ...
            if (c10 != null) {
                ...
                this.mIconView.setImageDrawable(c10);
            ...
            if (z10) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, d.a.f28622f);
            ...
            TooltipCompat.setTooltipText(this, z10 ? null : cVar.a());
        }
    }
    ...
    public ScrollingTabContainerView(Context context) {
        ...
        this.mStackedTabMaxWidth = b10.e();
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, d.a.f28628i);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, d.a.f28618d);
    ...
    public void addTab(a.c cVar, boolean z10) {
    ...
    public TabView createTabView(a.c cVar, boolean z10) {
    ...
    public void addTab(a.c cVar, int i10, boolean z10) {
        TabView createTabView = createTabView(cVar, false);
