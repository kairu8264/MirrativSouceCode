...
public class AppCompatBackgroundHelper {
    ...
    private boolean applyFrameworkTintUsingColorFilter(Drawable drawable) {
        ...
        tintInfo.clear();
        ColorStateList u10 = c0.u(this.mView);
        if (u10 != null) {
            tintInfo.mHasTintList = true;
            tintInfo.mTintList = u10;
        }
        PorterDuff.Mode v10 = c0.v(this.mView);
        if (v10 != null) {
            tintInfo.mHasTintMode = true;
            tintInfo.mTintMode = v10;
        }
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i10) {
        ...
        c0.p0(view, view.getContext(), iArr, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i10, 0);
        try {
            int i11 = j.P3;
            ...
            if (obtainStyledAttributes.hasValue(i12)) {
                c0.w0(this.mView, obtainStyledAttributes.getColorStateList(i12));
            }
            int i13 = j.R3;
            if (obtainStyledAttributes.hasValue(i13)) {
                c0.x0(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i13, -1), null));
            }
        } finally {
