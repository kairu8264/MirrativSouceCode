        ...
        if (a10 != null) {
            if (this.mHasCheckMarkTint || this.mHasCheckMarkTintMode) {
                ...
                if (this.mHasCheckMarkTint) {
                    g3.a.o(mutate, this.mCheckMarkTintList);
                }
                if (this.mHasCheckMarkTintMode) {
                    g3.a.p(mutate, this.mCheckMarkTintMode);
                }
    ...
    */
    public void loadFromAttributes(android.util.AttributeSet r10, int r11) {
        ...
        L58:
            ...
            s3.c.b(r11, r10)     // Catch: java.lang.Throwable -> L84
        L69:
            ...
            s3.c.c(r11, r10)     // Catch: java.lang.Throwable -> L84
        L80:
            r0.recycle()
            return
        L84:
