...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i10, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (view == null || view.getId() != 1) {
                        View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(g.f28745f, viewGroup, false);
                        inflate.setId(1);
                        ((TextView) inflate.findViewById(f.S)).setText(ActivityChooserView.this.getContext().getString(h.f28763b));
                        return inflate;
                    }
                    return view;
                }
            ...
            if (view == null || view.getId() != f.f28737x) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(g.f28745f, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i10);
            ((ImageView) view.findViewById(f.f28735v)).setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(f.S)).setText(resolveInfo.loadLabel(packageManager));
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            ...
            b bVar = ActivityChooserView.this.mProvider;
            if (bVar != null) {
    ...
    public void showPopupUnchecked(int i10) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            listPopupWindow.getListView().setContentDescription(getContext().getString(h.f28764c));
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i10) {
        ...
        c0.p0(this, context, iArr, attributeSet, obtainStyledAttributes, i10, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(j.G, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(j.F);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(g.f28744e, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(f.f28723j);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(f.f28731r);
        ...
        FrameLayout frameLayout2 = (FrameLayout) findViewById(f.f28733t);
        ...
        frameLayout2.setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: androidx.appcompat.widget.ActivityChooserView.3
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                c.M0(accessibilityNodeInfo).Y(true);
            }
        });
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(d.f28676d));
    }
}
