...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, t, r, s {
    private static final int ACTION_BAR_ANIMATE_DELAY = 600;
    public static final int[] ATTRS = {d.a.f28614b, 16842841};
    ...
    */
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        pullChildren();
        p0 y10 = p0.y(windowInsets, this);
        boolean applyInsets = applyInsets(this.mActionBarTop, new Rect(y10.k(), y10.m(), y10.l(), y10.j()), true, true, false, true);
        c0.h(this, y10, this.mBaseContentInsets);
        Rect rect = this.mBaseContentInsets;
        p0 n10 = y10.n(rect.left, rect.top, rect.right, rect.bottom);
        this.mBaseInnerInsets = n10;
        boolean z10 = true;
        if (!this.mLastBaseInnerInsets.equals(n10)) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (!this.mOverlayMode && !z10) {
            ...
            this.mInnerInsets = new p0.b(this.mInnerInsets).d(b.b(this.mInnerInsets.k(), this.mInnerInsets.m() + measuredHeight, this.mInnerInsets.l(), this.mInnerInsets.j() + 0)).a();
        } else {
        ...
        if (i12 >= 21 && !this.mLastInnerInsets.equals(this.mInnerInsets)) {
            p0 p0Var = this.mInnerInsets;
            this.mLastInnerInsets = p0Var;
            c0.i(this.mContent, p0Var);
        } else if (i12 < 21 && !this.mLastInnerInsetsRect.equals(this.mInnerInsetsRect)) {
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(f.f28715b);
            this.mActionBarTop = (ActionBarContainer) findViewById(f.f28716c);
            this.mDecorToolbar = getDecorToolbar(findViewById(f.f28714a));
        }
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        p0 p0Var = p0.f44009b;
        this.mBaseInnerInsets = p0Var;
        this.mLastBaseInnerInsets = p0Var;
        this.mInnerInsets = p0Var;
        this.mLastInnerInsets = p0Var;
