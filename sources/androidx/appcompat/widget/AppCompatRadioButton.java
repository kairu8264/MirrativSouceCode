...
public class AppCompatRadioButton extends RadioButton implements m, a0, EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatRadioButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mButtonTintId = propertyMapper.mapObject("buttonTint", d.a.f28662z);
            this.mButtonTintModeId = propertyMapper.mapObject("buttonTintMode", d.a.A);
    ...
    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, d.a.f28641o0);
    }
