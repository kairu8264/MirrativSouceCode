...
public final class UnityMiniGameOutputEmomoRunGameOver {
    ...
    public UnityMiniGameOutputEmomoRunGameOver(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, float f10, float f11, float f12, float f13, int i19) {
        this.selfTime = i10;
        this.selfRun = i11;
        this.giftedRun = i12;
        this.stageCoins = i13;
    ...
    public final UnityMiniGameOutputEmomoRunGameOver copy(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, float f10, float f11, float f12, float f13, int i19) {
        return new UnityMiniGameOutputEmomoRunGameOver(i10, i11, i12, i13, i14, i15, i16, i17, i18, f10, f11, f12, f13, i19);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnityMiniGameOutputEmomoRunGameOver) {
            UnityMiniGameOutputEmomoRunGameOver unityMiniGameOutputEmomoRunGameOver = (UnityMiniGameOutputEmomoRunGameOver) obj;
            return this.selfTime == unityMiniGameOutputEmomoRunGameOver.selfTime && this.selfRun == unityMiniGameOutputEmomoRunGameOver.selfRun && this.giftedRun == unityMiniGameOutputEmomoRunGameOver.giftedRun && this.stageCoins == unityMiniGameOutputEmomoRunGameOver.stageCoins && this.giftedCoins == unityMiniGameOutputEmomoRunGameOver.giftedCoins && this.giftedScore == unityMiniGameOutputEmomoRunGameOver.giftedScore && this.kicks == unityMiniGameOutputEmomoRunGameOver.kicks && this.coinBonus == unityMiniGameOutputEmomoRunGameOver.coinBonus && this.score == unityMiniGameOutputEmomoRunGameOver.score && p.c(Float.valueOf(this.presetRunScaler), Float.valueOf(unityMiniGameOutputEmomoRunGameOver.presetRunScaler)) && p.c(Float.valueOf(this.scoreRunMultiple), Float.valueOf(unityMiniGameOutputEmomoRunGameOver.scoreRunMultiple)) && p.c(Float.valueOf(this.scoreCoinMultiple), Float.valueOf(unityMiniGameOutputEmomoRunGameOver.scoreCoinMultiple)) && p.c(Float.valueOf(this.scoreKicksMultiple), Float.valueOf(unityMiniGameOutputEmomoRunGameOver.scoreKicksMultiple)) && this.stageEnemyMultiple == unityMiniGameOutputEmomoRunGameOver.stageEnemyMultiple;
        }
        return false;
    }
