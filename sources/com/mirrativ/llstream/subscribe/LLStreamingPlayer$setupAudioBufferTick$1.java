...
@f(c = "com.mirrativ.llstream.subscribe.LLStreamingPlayer$setupAudioBufferTick$1", f = "LLStreamingPlayer.kt", l = {551}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class LLStreamingPlayer$setupAudioBufferTick$1 extends l implements p<q0, d<? super v>, Object> {
    private /* synthetic */ Object L$0;
    public int label;
    public final /* synthetic */ LLStreamingPlayer this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LLStreamingPlayer$setupAudioBufferTick$1(LLStreamingPlayer lLStreamingPlayer, d<? super LLStreamingPlayer$setupAudioBufferTick$1> dVar) {
        super(2, dVar);
    ...
    public final d<v> create(Object obj, d<?> dVar) {
        LLStreamingPlayer$setupAudioBufferTick$1 lLStreamingPlayer$setupAudioBufferTick$1 = new LLStreamingPlayer$setupAudioBufferTick$1(this.this$0, dVar);
        lLStreamingPlayer$setupAudioBufferTick$1.L$0 = obj;
        return lLStreamingPlayer$setupAudioBufferTick$1;
    }

    @Override // io.p
    public final Object invoke(q0 q0Var, d<? super v> dVar) {
        return ((LLStreamingPlayer$setupAudioBufferTick$1) create(q0Var, dVar)).invokeSuspend(v.f59242a);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r6) {
        ...
        L25:
            ...
            java.util.concurrent.atomic.AtomicBoolean r3 = com.mirrativ.llstream.subscribe.LLStreamingPlayer.access$isAudioPlaying$p(r3)     // Catch: java.util.concurrent.CancellationException -> L4d
        ...
        L3e:
            ...
            com.mirrativ.llstream.subscribe.LLStreamingPlayer r3 = r6.this$0     // Catch: java.util.concurrent.CancellationException -> L4d
            com.mirrativ.llstream.subscribe.AACStreamer r3 = com.mirrativ.llstream.subscribe.LLStreamingPlayer.access$getAacStreamer$p(r3)     // Catch: java.util.concurrent.CancellationException -> L4d
            if (r3 == 0) goto L25
        ...
        L4d:
            ...
            if (r6 == 0) goto L5b
            java.lang.String r6 = "audioLoop has been cancelled"
            android.util.Log.d(r0, r6)
        L5b:
            wn.v r6 = wn.v.f59242a
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mirrativ.llstream.subscribe.LLStreamingPlayer$setupAudioBufferTick$1.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
