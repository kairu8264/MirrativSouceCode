...
public final class TtmlNode {
    ...
    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int i10, int i11, int i12) {
        ...
        if (resolveStyle != null) {
            TtmlRenderUtil.applyStylesToSpan(spannableStringBuilder2, i10, i11, resolveStyle, this.parent, map, i12);
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z10) {
        ...
        for (int i10 = 0; i10 < this.children.size(); i10++) {
            this.children.get(i10).getEventTimes(treeSet, z10 || equals);
        }
    }
    ...
    private void traverseForText(long j10, boolean z10, String str, Map<String, Cue.Builder> map) {
        ...
        if (this.isTextNode && z10) {
        ...
        } else if (TAG_BR.equals(this.tag) && z10) {
            ...
            boolean equals = TAG_P.equals(this.tag);
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                getChild(i10).traverseForText(j10, z10 || equals, str, map);
            }
            if (equals) {
