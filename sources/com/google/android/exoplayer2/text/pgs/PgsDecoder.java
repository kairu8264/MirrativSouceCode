    ...
    public static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i10) {
            ...
            while (i12 < i11) {
                ...
                this.colors[readUnsignedByte] = Util.constrainValue((int) (d10 + (d12 * 1.772d)), 0, 255) | (Util.constrainValue((int) ((d10 - (0.34414d * d12)) - (d11 * 0.71414d)), 0, 255) << 8) | (readUnsignedByte5 << 24) | (Util.constrainValue((int) ((1.402d * d11) + d10), 0, 255) << 16);
                i12 = i13 + 1;
            }
            this.colorsSet = true;
        }
        ...
        public Cue build() {
            ...
            while (i12 < i11) {
                ...
                if (readUnsignedByte != 0) {
                    i10 = i12 + 1;
                    iArr[i12] = this.colors[readUnsignedByte];
                } else {
                    int readUnsignedByte2 = this.bitmapData.readUnsignedByte();
                    if (readUnsignedByte2 != 0) {
                        i10 = ((readUnsignedByte2 & 64) == 0 ? readUnsignedByte2 & 63 : ((readUnsignedByte2 & 63) << 8) | this.bitmapData.readUnsignedByte()) + i12;
                        Arrays.fill(iArr, i12, i10, (readUnsignedByte2 & 128) == 0 ? 0 : this.colors[this.bitmapData.readUnsignedByte()]);
                    }
                }
                i12 = i10;
            }
