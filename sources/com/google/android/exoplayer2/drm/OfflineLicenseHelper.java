...
public final class OfflineLicenseHelper {
    ...
    private byte[] blockingKeyRequest(int i10, byte[] bArr, Format format) throws DrmSession.DrmSessionException {
        this.drmSessionManager.prepare();
        DrmSession openBlockingKeyRequest = openBlockingKeyRequest(i10, bArr, format);
    ...
    private DrmSession openBlockingKeyRequest(int i10, byte[] bArr, Format format) {
    ...
    public static OfflineLicenseHelper newWidevineInstance(String str, boolean z10, HttpDataSource.Factory factory, DrmSessionEventListener.EventDispatcher eventDispatcher) {
        return newWidevineInstance(str, z10, factory, null, eventDispatcher);
    }

    public static OfflineLicenseHelper newWidevineInstance(String str, boolean z10, HttpDataSource.Factory factory, Map<String, String> map, DrmSessionEventListener.EventDispatcher eventDispatcher) {
