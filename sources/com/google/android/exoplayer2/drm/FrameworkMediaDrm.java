...
public final class FrameworkMediaDrm implements ExoMediaDrm {
    ...
    public static final ExoMediaDrm.Provider DEFAULT_PROVIDER = q.f26842a;
    ...
    */
        ...
        if (Util.SDK_INT >= 28 && list.size() > 1) {
            ...
            if (z10) {
                ...
                for (int i13 = 0; i13 < list.size(); i13++) {
                    byte[] bArr3 = (byte[]) Assertions.checkNotNull(list.get(i13).data);
    ...
    public static /* synthetic */ ExoMediaDrm lambda$static$0(UUID uuid) {
        try {
            ...
            Log.e(TAG, "Failed to instantiate a FrameworkMediaDrm for uuid: " + uuid + TopicConstant.SEPARATOR);
    ...
    @Override // com.google.android.exoplayer2.drm.ExoMediaDrm
    public ExoMediaDrm.KeyRequest getKeyRequest(byte[] bArr, List<DrmInitData.SchemeData> list, int i10, HashMap<String, String> hashMap) throws NotProvisionedException {
        byte[] bArr2;
        String str;
        ...
        MediaDrm.KeyRequest keyRequest = this.mediaDrm.getKeyRequest(bArr, bArr2, str, i10, hashMap);
    ...
    public void setOnEventListener(final ExoMediaDrm.OnEventListener onEventListener) {
        this.mediaDrm.setOnEventListener(onEventListener == null ? null : new MediaDrm.OnEventListener() { // from class: com.google.android.exoplayer2.drm.n
            ...
            public final void onEvent(MediaDrm mediaDrm, byte[] bArr, int i10, int i11, byte[] bArr2) {
                FrameworkMediaDrm.this.lambda$setOnEventListener$1(onEventListener, mediaDrm, bArr, i10, i11, bArr2);
            }
        });
    }
        ...
        if (Util.SDK_INT >= 23) {
            this.mediaDrm.setOnExpirationUpdateListener(onExpirationUpdateListener == null ? null : new MediaDrm.OnExpirationUpdateListener() { // from class: com.google.android.exoplayer2.drm.o
                ...
                public final void onExpirationUpdate(MediaDrm mediaDrm, byte[] bArr, long j10) {
                    FrameworkMediaDrm.this.lambda$setOnExpirationUpdateListener$3(onExpirationUpdateListener, mediaDrm, bArr, j10);
                }
            }, (Handler) null);
            return;
        }
    ...
    public void setOnKeyStatusChangeListener(final ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener) {
        if (Util.SDK_INT >= 23) {
            this.mediaDrm.setOnKeyStatusChangeListener(onKeyStatusChangeListener == null ? null : new MediaDrm.OnKeyStatusChangeListener() { // from class: com.google.android.exoplayer2.drm.p
                @Override // android.media.MediaDrm.OnKeyStatusChangeListener
                public final void onKeyStatusChange(MediaDrm mediaDrm, byte[] bArr, List list, boolean z10) {
                    FrameworkMediaDrm.this.lambda$setOnKeyStatusChangeListener$2(onKeyStatusChangeListener, mediaDrm, bArr, list, z10);
                }
            }, (Handler) null);
            return;
        }
