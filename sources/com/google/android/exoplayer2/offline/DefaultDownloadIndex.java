...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public static Download getDownloadForCurrentRow(Cursor cursor) {
        ...
        return new Download(build, i10, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), i10 == 4 ? cursor.getInt(11) : 0, downloadProgress);
    }
    ...
    private static String inferMimeType(String str) {
        return "dash".equals(str) ? MimeTypes.APPLICATION_MPD : TopicConstant.PACKET_TYPE_HLS.equals(str) ? MimeTypes.APPLICATION_M3U8 : "ss".equals(str) ? MimeTypes.APPLICATION_SS : MimeTypes.VIDEO_UNKNOWN;
    }
    ...
    private void putDownloadInternal(Download download, SQLiteDatabase sQLiteDatabase) {
        ...
        contentValues.put("id", download.request.f26898id);
