...
public final class HlsMasterPlaylist extends HlsPlaylist {
    ...
    public HlsMasterPlaylist(String str, List<String> list, List<Variant> list2, List<Rendition> list3, List<Rendition> list4, List<Rendition> list5, List<Rendition> list6, Format format, List<Format> list7, boolean z10, Map<String, String> map, List<DrmInitData> list8) {
        super(str, list, z10);
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                if (i12 < list2.size()) {
                    ...
                    if (streamKey.groupIndex == i10 && streamKey.trackIndex == i11) {
                        arrayList.add(t10);
                        break;
                    }
                    i12++;
