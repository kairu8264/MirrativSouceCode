...
public class PlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
    ...
    public final class ComponentListener implements Player.EventListener, TextOutput, VideoListener, View.OnLayoutChangeListener, SingleTapListener, PlayerControlView.VisibilityListener {
        ...
        public void onVideoSizeChanged(int i10, int i11, int i12, float f10) {
            ...
            playerView.onContentAspectRatioChanged(f11, playerView.contentFrame, PlayerView.this.surfaceView);
        }
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.controllerShowTimeoutMs = playerControlView3 != null ? i11 : i17;
        this.controllerHideOnTouch = z12;
        this.controllerAutoShow = z10;
        this.controllerHideDuringAds = z11;
        this.useController = (!z15 || playerControlView3 == null) ? i17 : 1;
        hideController();
        updateContentDescription();
