...
final class AudioTagPayloadReader extends TagPayloadReader {
    ...
    private static final int[] AUDIO_SAMPLING_RATE_TABLE = {5512, 11025, 22050, AACEncoder.SAMPLING_RATE};
    ...
    public boolean parseHeader(ParsableByteArray parsableByteArray) throws TagPayloadReader.UnsupportedFormatException {
        if (!this.hasParsedAudioDataHeader) {
            ...
            if (i10 == 2) {
                ...
                this.output.format(new Format.Builder().setSampleMimeType(i10 == 7 ? MimeTypes.AUDIO_ALAW : MimeTypes.AUDIO_MLAW).setChannelCount(1).setSampleRate(8000).build());
                this.hasOutputFormat = true;
            } else if (i10 != 10) {
