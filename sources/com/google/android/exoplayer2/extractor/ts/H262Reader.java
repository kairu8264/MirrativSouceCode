    ...
    */
    ...
    public void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            int i12 = parsableByteArray.getData()[i11] & TagConstant.TAG_CAT_RESERVED;
            ...
            if (nalUnitTargetBuffer != null) {
                ...
                if (i12 == START_USER_DATA && parsableByteArray.getData()[findNalUnit + 2] == 1) {
            ...
            if (i12 == 0 || i12 == START_SEQUENCE_HEADER) {
                ...
                if (!z10 || this.sampleHasPicture) {
                    ...
                    if (j10 == C.TIME_UNSET) {
                        j10 = z10 ? this.sampleTimeUs + this.frameDurationUs : 0L;
                    }
