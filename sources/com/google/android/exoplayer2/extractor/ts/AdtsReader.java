...
public final class AdtsReader implements ElementaryStreamReader {
            ...
            if (i11 == -1 || readBits == i11) {
                ...
                if (tryRead(parsableByteArray, this.adtsScratch.data, 4)) {
                    ...
                    if (data[i12] == -1) {
                        ...
                        return isAdtsSyncBytes((byte) -1, data[i13]) && ((data[i13] & 8) >> 3) == readBits;
                    } else if (data[i12] != 73) {
                        return false;
                    } else {
                        int i14 = i12 + 1;
    ...
    private void findNextSample(ParsableByteArray parsableByteArray) {
        ...
        while (position < limit) {
            int i10 = position + 1;
            int i11 = data[position] & TagConstant.TAG_CAT_RESERVED;
    ...
    private boolean isAdtsSyncBytes(byte b10, byte b11) {
        return isAdtsSyncWord(((b10 & TagConstant.TAG_CAT_RESERVED) << 8) | (b11 & TagConstant.TAG_CAT_RESERVED));
    }
