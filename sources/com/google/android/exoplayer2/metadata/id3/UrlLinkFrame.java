...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f26893id.equals(urlLinkFrame.f26893id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url);
    }
    ...
    public String toString() {
        return this.f26893id + ": url=" + this.url;
    }
