...
public final class BinaryFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f26893id.equals(binaryFrame.f26893id) && Arrays.equals(this.data, binaryFrame.data);
    }

    public int hashCode() {
        return ((527 + this.f26893id.hashCode()) * 31) + Arrays.hashCode(this.data);
    }
