...
public final class SimpleCache implements Cache {
    ...
    private static long createUid(File file) throws IOException {
        ...
        File file2 = new File(file, l10 + UID_FILE_SUFFIX);
    ...
    private void loadDirectory(File file, boolean z10, File[] fileArr, Map<String, CacheFileMetadata> map) {
        ...
        for (File file2 : fileArr) {
            ...
            if (z10 && name.indexOf(46) == -1) {
                ...
                SimpleCacheSpan createCacheEntry = SimpleCacheSpan.createCacheEntry(file2, j10, j11, this.contentIndex);
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        if (this.touchCacheSpans) {
            ...
            SimpleCacheSpan lastTouchTimestamp = this.contentIndex.get(str).setLastTouchTimestamp(simpleCacheSpan, currentTimeMillis, z10);
    ...
    */
    ...
    public synchronized File startFile(String str, long j10, long j11) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f27044id, j10, System.currentTimeMillis());
    }
    ...
    public synchronized CacheSpan startReadWriteNonBlocking(String str, long j10, long j11) throws Cache.CacheException {
        ...
        } else if (this.contentIndex.getOrAdd(str).lockRange(j10, span.length)) {
            return span;
        } else {
            return null;
        }
