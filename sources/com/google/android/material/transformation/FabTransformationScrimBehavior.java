...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        public final /* synthetic */ View f27919b;
    ...
    public FabTransformationScrimBehavior() {
        this.f27916c = new i(75L, 150L);
        this.f27917d = new i(0L, 150L);
    }
    ...
    public final void K(View view, boolean z10, boolean z11, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofFloat;
        i iVar = z10 ? this.f27916c : this.f27917d;
        if (z10) {
            if (!z11) {
                view.setAlpha(0.0f);
            }
