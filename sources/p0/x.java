...
public final class x {
    ...
    public static final <K, V> Object[] g(Object[] objArr, int i10, K k10, V v10) {
        ...
        xn.n.m(objArr, objArr2, 0, 0, i10, 6, null);
        xn.n.i(objArr, objArr2, i10 + 2, i10, objArr.length);
        objArr2[i10] = k10;
        objArr2[i10 + 1] = v10;
        return objArr2;
    }
    ...
    public static final Object[] h(Object[] objArr, int i10) {
        Object[] objArr2 = new Object[objArr.length - 2];
        xn.n.m(objArr, objArr2, 0, 0, i10, 6, null);
        xn.n.i(objArr, objArr2, i10, i10 + 2, objArr.length);
        return objArr2;
    }
    ...
    public static final Object[] i(Object[] objArr, int i10) {
        ...
        xn.n.m(objArr, objArr2, 0, 0, i10, 6, null);
        xn.n.i(objArr, objArr2, i10, i10 + 1, objArr.length);
        return objArr2;
    }
    ...
    public static final Object[] j(Object[] objArr, int i10, int i11, t<?, ?> tVar) {
        ...
        xn.n.m(objArr, objArr2, 0, 0, i10, 6, null);
        xn.n.i(objArr, objArr2, i10, i10 + 2, i11);
        objArr2[i12] = tVar;
        xn.n.i(objArr, objArr2, i12 + 1, i11, objArr.length);
        return objArr2;
    }
    ...
    public static final <K, V> Object[] k(Object[] objArr, int i10, int i11, K k10, V v10) {
        ...
        xn.n.i(copyOf, copyOf, i10 + 2, i10 + 1, objArr.length);
        xn.n.i(copyOf, copyOf, i11 + 2, i11, i10);
        copyOf[i11] = k10;
        copyOf[i11 + 1] = v10;
        return copyOf;
    }
